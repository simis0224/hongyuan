...
<title>安装向导 - Powered by www.ymjd.cn</title>
    ...
    <tr>
      <td width="229" valign="top" align="center"> 
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            <td align="center"><p style="FONT:bold 12px/20px Verdana, Arial, Helvetica, sans-serif;color:#fff;">Powered By <a href="http://www.ymjd.cn" target="_blank" style="color:#fff;">phpweb.net</a></td>
          </tr>
        </table>
      </td>

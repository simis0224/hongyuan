...
<input type="hidden" id="previewsrc_<?php echo $id; ?>"  value="<?php echo $src; ?>">
		  ...
		  <tr> 
            ...
            <td height="30" > 
             <input id="newsbody" type="hidden" name="body" value="<?php echo $body; ?>" />
      ...
      <td height="30" >
	  	<input name="tags[]" type="text" class="input" id="tags"  value="<?php echo $tags[0]; ?>" size="11" />
        <input name="tags[]" type="text" class="input" id="tags"  value="<?php echo $tags[1]; ?>" size="11" />
        <input name="tags[]" type="text" class="input" id="tags"  value="<?php echo $tags[2]; ?>" size="11" />
        <input name="tags[]" type="text" class="input" id="tags"  value="<?php echo $tags[3]; ?>" size="11" />
        <input name="tags[]" type="text" class="input" id="tags"  value="<?php echo $tags[4]; ?>" size="11" /></td>
    </tr>
      ...
      <td height="30" valign=top> 
        ...
        <?php echo $strDownAddUpload; ?> 
          ...
          <tr> 
            ...
            <td height="30" > 
              <input type="text" name="author" style='WIDTH: 499px;' maxlength="100" class=input value="<?php echo $author; ?>" />
            </td>
          </tr>
          <tr> 
            <td height="30" width="100" align="center" ><?php echo $strNewsAddSource; ?></td>
            <td height="30" > 
              <input type="text" name="source" style='WIDTH: 499px;' maxlength="100" class="input" value="<?php echo $source; ?>" />
            </td>
          </tr>
		  <tr> 
